  ...
  const HandleFavourite = async () =>
  {
    try
    {
      const res = currentUser.favourites.some(favourite => favourite._id === _id)
        ? (await axios.put('https://imagegeneratorai-9kb4.onrender.com/api/v1/user/unfavourite', { _id }, { withCredentials: true }))
        : (await axios.put('https://imagegeneratorai-9kb4.onrender.com/api/v1/user/favourite', { _id }, { withCredentials: true }))
