...
function Share({description, url}) {
  ...
  return (
    ...
    {/* Facebook */}
    <div onClick={() => window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(url)}&quote=${encodeURIComponent(description)}`)}>
    ...
    {/* Twitter */}
    <div onClick={() => window.open(`https://twitter.com/intent/tweet?url=${url}&text=${encodeURI(description)}&via=Dreamscape&related=Dreamscape`)}>
    ...
    {/* Pintrest */}
    <div onClick={() => window.open(`https://pinterest.com/pin/create/button/?url=${url}&media=&description=${encodeURI(description)}`)}>
    ...
    {/* Pintrest */}
    <div onClick={() => window.open(`https://www.linkedin.com/shareArticle?mini=true&url=${url}`)}>
    ...
    {/* Email */}
    <div onClick={() => window.open(`mailto:info@example.com?&subject=You+have+to+See+this!&cc=&bcc=&body=Check+out+this+site:${url}\n${encodeURI(description)}`)}>
