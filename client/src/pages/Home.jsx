...
const Home = ({ type }) => {
    ...
    useEffect(() =>
    {
        const fetchPosts = async() =>
        {
            ...
            try
            {
                const res = type === 'user' ? await axios.get('http://localhost:8080/api/v1/post/user-posts', { withCredentials: true }) : type === 'favourites' ? await axios.get('http://localhost:8080/api/v1/post/favourites', { withCredentials: true }) : await axios.get('http://localhost:8080/api/v1/post', { withCredentials: true })
  ...
  return (
    <section className='max-w-7xl mx-auto'>
        <div>
            ...
            <p className='mt-2 text-[#666e75] dark:text-[#CCCCCC] text-[16px] max-w-[500px]'>{type === 'user' ? 'Your unique creations shared with the Dreamcast community' : type === 'favourites' ? 'Your favourite works of art from the Dreamcast community' : 'Discover a stunning collection of imaginative and visually stunning images generated by Dreamscape'}</p>
        </div>
        <div className='mt-16'>
            <Form
