...
const Home = ({ type }) => {
    ...
    useEffect(() =>
    {
        const fetchPosts = async() =>
        {
            ...
            try
            {
                const res = type === 'user' ? await axios.get('https://imagegeneratorai-9kb4.onrender.com/api/v1/post/user-posts', { withCredentials: true }) : type === 'favourites' ? await axios.get('https://imagegeneratorai-9kb4.onrender.com/api/v1/post/favourites', { withCredentials: true }) : await axios.get('https://imagegeneratorai-9kb4.onrender.com/api/v1/post', { withCredentials: true })
