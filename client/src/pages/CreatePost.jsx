...
const CreatePost = () => {
  ...
  const HandleSubmit = async (e) =>
  {
    ...
    if (form.prompt && form.photo)
    {
      ...
      try {
        const res = await axios.post('https://imagegeneratorai-server.onrender.com/api/v1/post', {...form}, { withCredentials: true })
        navigate('/')
      }
      catch (error)
      {
  ...
  const HandleGenerate = async () =>
  {
    if (form.prompt)
    {
      ...
      try
      {
        ...
        const res = await axios.post('https://imagegeneratorai-server.onrender.com/api/v1/dalle', { prompt: form.prompt }, { withCredentials: true })
